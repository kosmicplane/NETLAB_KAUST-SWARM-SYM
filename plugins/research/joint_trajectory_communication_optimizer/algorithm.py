"""Joint Trajectory and Communication Optimizer NETLAB reference plugin."""
from netlab.algorithm_baselines import joint_trajectory_communication as _implementation
